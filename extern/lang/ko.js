...
Lang.Menus = {
    ...
    "select_email_unauthenticated_user": "해당 이메일 주소가 아래 계정에 등록되어 있습니다.\n인증을 원하는 계정을 선택해주세요.",
    ...
    "textcoding_numberError_f": "등록된 함수 중에 이름의 첫 글자가 숫자인 함수가 있으면 모드 변환을 할 수 없습니다.",
    "textcoding_bookedError_1f": "등록된 함수 중에 이름이",
    "textcoding_bookedError_2f": "인 함수가 있으면 모드 변환을 할 수 없습니다.",
    "textcoding_specialCharError_f": "등록된 함수 중 이름에 '_' 를 제외한 특수 문자가 있으면 모드 변환을 할 수 없습니다.",
    ...
    "faq_title": "자주하는 질문",
    "faq": "자주하는 질문",
    "malicious_warning": "불건전한 사진은 불러올 수 없습니다. 불건전한 사진이 아닌 경우 제안 및 건의에 해당 사진을 첨부하여 신고해주세요.",
    ...
    "file_upload_warn_desc_image": "폭력적이고 잔인한 그림<br>선정적인 신체노출 그림<br>불쾌감을 주거나 혐오감을 일으키는 그림<br>무단 사용이 금지된 저작권의 그림",
    "file_upload_warn_title_sound": "아래와 같은 소리는 이용약관 및 관련 법률에 의해 제재를 받을 수 있습니다.",
    "file_upload_warn_desc_sound": "폭력적이고 잔인한 소리<br>선정적인 내용의 소리<br>불쾌감을 주거나 혐오감을 일으키는 소리<br>무단 사용이 금지된 저작권의 소리",
    "file_upload_warn_link": "저작권에 대해 알아보기",
    "file_upload_desc_1": "아래와 같은 그림은 이용약관 및 관련 법률에 의해 제재를 받으실 수 있습니다.",
    ...
    "context_textbook": "초등 교과서 그대로 선생님은 학교 수업을 학생은 집에서 예습, 복습을 할 수 있어요.",
    ...
    "footer_description_1": "엔트리는 비영리 교육 플랫폼으로 모든 엔트리의 저작물은 교육 목적에 한해 출처를 밝히고 자유롭게 이용할 수 있습니다.",
    ...
    "painter_contest_title": "엔트리 캠페인 #2 개성있는 작품 만들기",
    "painter_content_head": "진화된 그림판과 새로운 오브젝트",
    "painter_content_body1": "벡터 이미지 편집과 새로 추가된 오브젝트로",
    "painter_content_body2": "더 멋진 작품 만드는 법",
    "painter_content_button": "캠페인 보기",
    ...
    "search_피지컬": "피지컬",
    "search_기타": "기타",
    "discuss_write_textarea_placeholer": "엔트리 커뮤니티는 우리가 함께 만들어가는 공간입니다.\n서로 배려하는 말로 즐거운 커뮤니티를 만들어요!\n\n 욕설이나 음란물과 같은 부적절한 내용의 글을 작성할 경우 이용정지 될 수 있습니다.",
    "discuss_write_textarea_placeholer_qna": "여기는 묻고답하기 게시판입니다.\n서로 배려하는 말로 즐거운 커뮤니티를 만들어요!\n\n 욕설이나 음란물과 같은 부적절한 내용의 글을 작성할 경우 이용정지 될 수 있습니다.",
    "discuss_write_textarea_placeholer_tips": "여기는 노하우&팁 게시판입니다.\n서로 배려하는 말로 즐거운 커뮤니티를 만들어요!\n\n 욕설이나 음란물과 같은 부적절한 내용의 글을 작성할 경우 이용정지 될 수 있습니다.",
    "discuss_write_textarea_placeholer_free": "여기는 엔트리 이야기 게시판입니다.\n서로 배려하는 말로 즐거운 커뮤니티를 만들어요!\n\n 욕설이나 음란물과 같은 부적절한 내용의 글을 작성할 경우 이용정지 될 수 있습니다.",
    "discuss_write_textarea_placeholer_report": "여기는 제안 및 건의 게시판입니다.\n서로 배려하는 말로 즐거운 커뮤니티를 만들어요!\n\n 욕설이나 음란물과 같은 부적절한 내용의 글을 작성할 경우 이용정지 될 수 있습니다.",
...
Lang.Msgs = {
    ...
    "expansion_translate_description": "파파고를 이용하여 다른 언어로 번역할 수 있는 블록 모음입니다. [네이버 제공]",
    ...
    "expansion_tts_description": "nVoice 음성합성 기술로 다양한 목소리로 문장을 읽는 블록모음 입니다. [네이버 제공]",
...
Lang.Helper = {
    ...
    "text_read": "선택한 글상자에 작성된 내용입니다. (내용 안에 줄 바꿈이 있는 경우, 띄어쓰기하여 반환됩니다.)",
    ...
    "get_translated_string": "입력한 문자값을 선택한 언어로 번역합니다. 입력은 20자까지 가능합니다.\n*번역 가능한 언어 \n - 한국어 → 영어, 중국어 간체, 중국어 번체, 베트남어, 스페인어, 인도네시아어, 태국어, 프랑스어\n - 영어 → 일본어, 프랑스어, 한국어\n - 중국어 간체, 중국어 번체, 베트남어, 스페인어, 인도네시아어, 태국어, 프랑스어 → 한국어\n - 일본어 →영어 \n - 프랑스어 → 영어",
    "check_language": "입력된 문자값의 언어를 감지합니다. 입력은 문장 형태로 20자까지 가능합니다.",
