...
Lang.Menus = {
    ...
    "file_upload_desc_1": "下のような画像は、利用規約および関連の法律によって制裁を受けることがあります。",
    ...
    "painter_contest_title": "個性のある作品作り",
    "painter_content_head": "新しく変わったペイント",
    "painter_content_body1": "ベクトルイメージ編集と新しいオブジェクトを",
    "painter_content_body2": "用いて素晴らしい作品を作る",
    "painter_content_button": "キャンペーンを見る",
...
Lang.Workspace = {
    ...
    "check_audio_msg": "MP3ファイルのみアップロードできます。",
...
Lang.Helper = {
    ...
    "get_translated_string": "<br>入力されたテキストを選択した言語に翻訳します。テキストは20字まで入力可能です。",
    "check_language": "<br>入力されたテキストの言語を検出します。テキストは文章の形で、20字まで入力可能です。",
